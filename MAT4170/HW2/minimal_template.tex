...
Notice that the following \(5 \times 5\) multiplication table has the Latin Square property, in that each row and column has no duplicate values. You will determine whether or not this is a Cayley table for a group.1
